...
Built-in tools (Read, Bash, etc.) work on your local machine. MCP servers are integrations that Claude's creators or the community have built to connect Claude to specific external systems. They extend what Claude can reach.
